...
* watsonx 30日無料評価版やIBM Cloud からWatson Machine Learning (watsonx.ai Runtime)のライト・プランをお使いの方は、残りのトークン数に気をつけながら、この演習を実施してください。
...
* 2025年9月2日時点で、Watson Machine Learning ライト・プランを使うと、300,000トークンまで無料で利用できます。
* トークンは文字数とは異なります。
