...
## (オプション) Wikipediaエージェントをデプロイします。興味のある方は、試してください。
...
量子コンピューターとは
```
<img width="1200" height="1063" alt="5-1-16-QuickStart" src="https://github.com/user-attachments/assets/3a52cf60-a0c8-4c3f-b587-713a9eb5a5d4" />
...
```
<img width="1200" height="1063" alt="5-1-17-AboutTV" src="https://github.com/user-attachments/assets/584fbb8d-4c5e-48ae-812e-3473df59d21a" />

18. チャットをクリアし、[衛星放送とは]、[量子コンピューターとは]をクリックしてみましょう。ツールに渡すキーワードが判別できないため、おそらく動作しません。

19.　[衛星放送とは]、[量子コンピューターとは]、この２つのクイック・スタートに関する質問を変更します。
* 質問2:
```
"satellite broadcasting"とは
```
* 質問3:
```
Quantum Computerとは
...
* ["satellite broadcasting"とは]の質問はツールの呼び出しがループしてしまい、失敗します。
