...
2. [プロジェクトの作成]ページが表示されます。

* 2026/1/21追記: [プロジェクトの作成] 画面において、API keyの作成が必要な場合に、画面が正しく日本語化できていない問題を見つけています。

　<img width="1121" height="1094" alt="5-1-1-CreateProject" src="https://github.com/user-attachments/assets/67347991-845e-4b8c-acf6-ceecee0b32e2" />

* ブラウザーの言語設定を[英語]に切り替えると、日本語化できていない部分に何が表示されているかがわかります。
  <img width="1121" height="1094" alt="5-1-1-1-EnglishScreen" src="https://github.com/user-attachments/assets/9ea2b97a-f6d8-4f73-be48-8c9a9e6cc3e5" />

* 日本語表示の場合 [日本語〜Create a key〜ja]をクリック、英語表示の場合[Create a key]をクリックして、API keyを作成してください。

* API keyの問題が解決したら、[詳細の定義]欄で、プロジェクトを識別するための[名前]を入力して[作成]をクリックします。
