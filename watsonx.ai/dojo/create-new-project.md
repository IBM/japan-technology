...
参考URL: IBM watsonx as a Service 、プロジェクトの作成
...
参考URL:
* プロジェクト資産のインポート
  https://dataplatform.cloud.ibm.com/docs/content/wsj/manage-data/import-project-assets.html?context=wx&audience=wdp 
* プロジェクト資産のエクスポート 
  https://dataplatform.cloud.ibm.com/docs/content/wsj/manage-data/export-project.html?context=wx&audience=wdp
