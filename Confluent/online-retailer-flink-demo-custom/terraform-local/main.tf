...
# ------------------------------------------------------
# CDC Topics (for Debezium PostgreSQL Connector)
# ------------------------------------------------------

resource "confluent_kafka_topic" "cdc-customers" {
  kafka_cluster {
    id = confluent_kafka_cluster.standard.id
  }
  topic_name         = "shiftleft.public.customers"
  rest_endpoint      = confluent_kafka_cluster.standard.rest_endpoint
  credentials {
    key    = confluent_api_key.app-manager-kafka-api-key.id
    secret = confluent_api_key.app-manager-kafka-api-key.secret
...
resource "confluent_kafka_topic" "cdc-addresses" {
  kafka_cluster {
    id = confluent_kafka_cluster.standard.id
  }
  topic_name         = "shiftleft.public.addresses"
  rest_endpoint      = confluent_kafka_cluster.standard.rest_endpoint
  credentials {
    key    = confluent_api_key.app-manager-kafka-api-key.id
    secret = confluent_api_key.app-manager-kafka-api-key.secret
...
resource "confluent_kafka_topic" "cdc-products" {
  kafka_cluster {
    id = confluent_kafka_cluster.standard.id
  }
  topic_name         = "shiftleft.public.products"
  rest_endpoint      = confluent_kafka_cluster.standard.rest_endpoint
  credentials {
    key    = confluent_api_key.app-manager-kafka-api-key.id
    secret = confluent_api_key.app-manager-kafka-api-key.secret
...
resource "confluent_kafka_topic" "cdc-orders" {
  kafka_cluster {
    id = confluent_kafka_cluster.standard.id
  }
  topic_name         = "shiftleft.public.orders"
  rest_endpoint      = confluent_kafka_cluster.standard.rest_endpoint
  credentials {
    key    = confluent_api_key.app-manager-kafka-api-key.id
    secret = confluent_api_key.app-manager-kafka-api-key.secret
...
resource "confluent_kafka_topic" "cdc-order-items" {
  kafka_cluster {
    id = confluent_kafka_cluster.standard.id
  }
  topic_name         = "shiftleft.public.order_items"
  rest_endpoint      = confluent_kafka_cluster.standard.rest_endpoint
  credentials {
    key    = confluent_api_key.app-manager-kafka-api-key.id
    secret = confluent_api_key.app-manager-kafka-api-key.secret
...
resource "confluent_schema" "avro-payments" {
  ...
  format = "AVRO"
  schema = file("../terraform/schemas/avro/payments-value.avsc")
  hard_delete = true
  credentials {
