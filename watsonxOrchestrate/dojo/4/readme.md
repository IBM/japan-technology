...
## [ADKでAIエージェントを作る](https://github.com/IBM/japan-technology/blob/main/watsonxOrchestrate/dojo/4/1-HelloAgent/readme.md)
...
Visual Studio CodeのADK拡張機能を利用して、AIエージェントから呼び出すPythonツールを作成します。
