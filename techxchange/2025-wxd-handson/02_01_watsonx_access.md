...
1.左上のハンバーガーメニューをクリックし、メニュー下部の「watsonx」を選択します。
 ...
 4.ログイン後、まず、トロント・リージョンにいるか確認してください。
 <img width="800" alt="" src="images/02_01_1201add1.jpg"><br>

 つぎに、プロファイルの右側のアイコンをクッリクして、IBM watsonx.dataプラットフォームにいるのかを確認します。<br>
<img width="800" alt="" src="images/02_01_1201add2.jpg"><br>
&nbsp;<br>
<img width="300" alt="" src="images/02_01_1201add3.jpg"><br>
...
1. 上部の「資産」タブをクリック後、「**新規資産**」をクリックし、「**データソースへの接続**」をクリックします。<br>
...
Milvusはwatsonx.dataに統合されたベクター・データベースです。この接続により、PDFなどの非構造化コンテンツから生成されたベクトル埋め込みを保存し、インデックス化や検索ができるようになります。<br>
同様に、 watsonx.data Milvus接続もプラットフォーム・レベルで作成済みです。<br>
...
2.[接続の追加]画面で、次の操作を行います。<br>
- ①「**プラットフォーム接続**」をクリックします。<br>
- ②「IBM watsonx.data Milvus」コネクター「**Milvus**」を選択します。<br>
- ③「**次へ**」をクリックします。<br>
<img width="800" alt="" src="images/02_01_milvus01.jpg"><br>

3. [接続の作成]画面で、次の操作を行います。<br>
- ① [接続のテスト]をクッリクしてセットアップを確認します。<br>
- ② 緑色で「**テストは正常に終了しました。**」と表示されていることを確認します。<br>
...
非構造化データを取り込む前に、Prestoをストレージ・エンジンとして設定します。抽出したメタデータをIcebergテーブルに保存し、後でPrestoから簡単にクエリできるようになります。<br>

セットアップ手順は次のとおりです。

1.プロジェクトで、画面上部の「**管理**」タブをクリックし(①)、左側の「**ツール**」メニューで「**非構造化データの統合**」を選択します(②)。 「文書セット・ストレージ」の下にある青いボタン「**接続の追加**」をクリックします。(③)<br>
