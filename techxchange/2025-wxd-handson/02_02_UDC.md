...
2.下にスクロールし、「**非構造化データの分析とエンリッチ化**」を選択します。<br>
<img width="800" alt="" src="images/02_02_UDC02.jpg"><br>

3.名前を入力します。先頭は必ずアルファベットで作成してください。例「TechXchange_UDC_xxxxx」<br>
**名前はハンズオン講師の指示に従って入力してください** (**xxxxx**の指定があります)。<br>
...
7.資産が追加されたら、右側の「**分析の構成**」をクリックし、構成を表示します。<br>
<img width="800" alt="" src="images/02_02_UDC07.jpg"><br>
[分析の構成]では、ドキュメント・サイズ、サポートされているスクリプト、文書クラスなどの設定ができます。<br>
`サポートされているスクリプト`のドロップダウンリストから「**中国語/日本語/韓国語**」を選択して、セットします。<br>
...
&nbsp;<br>
再度「ドキュメントクラスの選択」画面に戻るので「キャンセル」をクリックします。<br>
&nbsp;<br>
最後に「保存」をクリックします。
&nbsp;<br>
...
この間に分析フローを確認しましょう。右上の「**(i)**」(正確にはiを丸で囲んだアイコン)をクリックし、「**メトリックの表示**」をクリックします。<br>
...
&nbsp;<br>
右上の「**新しいドキュメント ライブラリ　＋**」をクリックします。<br>
<img width="800" alt="" src="images/02_02_UDC23-1.jpg"><br>
&nbsp;<br>
名前に**`invoice-document-library`** と入力し、「**作成**」をクリックします。<br>
<img width="800" alt="" src="images/02_02_UDC23-2.jpg"><br>
&nbsp;<br>
作成した「**invoice-document-library**」が選択されていることを確認し、「**選択**」をクリックします。<br>
...
17.処理が開始されます。処理時間は大体3分です。この間にフローを確認しましょう。右上の「**メトリックの表示**」をクリックします。<br>
